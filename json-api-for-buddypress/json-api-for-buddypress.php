...
function draw_notice_buddypress() {
    echo '<div id="message" class="error fade"><p style="wwline-height: 150%">';
...
function draw_notice_json_api() {
    ...
    _e('<strong>JSON API for Buddypress</strong></a> requires the JSON Api plugin to be activated. Please <a href="http://wordpress.org/extend/plugins/json-api/">install / activate JSON Api</a> first, or <a href="plugins.php">deactivate JSON API for Buddypress</a>.', 'json-api-for-buddypress');
    echo '</p></div>';
}
